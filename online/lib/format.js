...
(function ($) {
  ...
  var formatReg = baseReg.compile ? baseReg.compile(baseReg.source, "g") || baseReg : baseReg;
  // 其他工具函数
  ...
  $.format = function (string, source) {
    ...
    // 检测数据源
    var data = type === "[object Object]" ? (isArray = false, source) : type === "[object Array]" ? source : slice.call(arguments, 1);
